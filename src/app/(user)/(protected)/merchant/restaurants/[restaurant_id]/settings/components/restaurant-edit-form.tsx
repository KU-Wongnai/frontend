...
let marker: any;
const RestaurantEditForm = ({ restaurant }: { restaurant: Restaurant }) => {
    ...
    const onSubmit = async (data: RestaurantForm) => {
        ...
        try {
            await updateRestaurant(data, restaurant.id);
    ...
    return (
        <div className="">
            <div className="container py-10 mt-14 md:px-20">
                <p className="text-3xl font-bold">Edit your restaurant</p>
